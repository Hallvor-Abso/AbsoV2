...
const OVERLAYS: OverlayDef[] = [
  ...
  },
  {
    ...
    desc: 'Panneau d’infos en fondu ; remplit sa source (à dimensionner sur la caméra) et le texte s’ajuste toujours à sa taille. Messages perso + infos auto.',
    shared: [],
    fields: [
      ...
      { param: 'logo', label: 'Logo de la guilde (carré fixe à gauche)', kind: 'toggle', defaultOn: false, on: '1' },
    ],
  },
  {
    id: 'goal',
